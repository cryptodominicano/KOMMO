...
El precio del estudio completo de agua (topográfico + radiestesia + geohidrológico) es de RD$50,000 en las siguientes provincias: Monte Cristi, Dajabón, Santiago Rodríguez, Valverde (Mao), Elías Piña, San Juan, Bahoruco, Independencia, Barahona, Pedernales, Hato Mayor, El Seibo, San Pedro de Macorís, La Romana y La Altagracia.
Cuando el cliente mencione un pueblo, sector, paraje o municipio, identifica a qué provincia pertenece (incluyendo comunidades cercanas dentro de esas provincias). Si el terreno está en cualquiera de estas provincias, informa que el costo del estudio es de RD$50,000. El cargo adicional por acceso difícil de RD$5,000 aplica igual que en las demás zonas, siempre con previo aviso y aprobación del cliente.

## Cargo adicional por acceso difícil al terreno (RD$5,000)
Si el acceso al terreno es muy difícil y el técnico no puede llegar en vehículo hasta el área donde se realizará el estudio, puede aplicar un cargo adicional de RD$5,000. Esto ocurre cuando es necesario transportar los equipos a mano durante una larga distancia, ya que el estudio requiere varios equipos especializados y, en esos casos, debemos llevar un ayudante adicional o realizar varios recorridos para trasladar todo el equipo de forma segura.
Este cargo solo aplica en casos de acceso complicado. Siempre se le informa al cliente y se solicita su aprobación antes de realizar el estudio; nunca se aplica por sorpresa.
