...
Para ordenar se necesita un depósito de RD$5,000 y la ubicación donde lo necesita (municipio y sector). Al enviar el mensaje de orden, el sistema comparte automáticamente una imagen con los datos de la cuenta para el depósito. El cliente hace el depósito y envía el comprobante por el mismo chat; ahí un técnico verifica el pago, procesa la orden y agenda la entrega. El pago restante se hace cuando reciba el módulo en su ubicación. El asistente nunca escribe números de cuenta en texto: los datos van únicamente en esa imagen.
